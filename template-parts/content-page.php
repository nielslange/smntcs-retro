...
if ( get_theme_mod( 'smntcs_retro_page_show_author', true ) ) {
	smntcs_retro_post_author();
}

// Display the post date on post pages.
if ( get_theme_mod( 'smntcs_retro_page_show_date', true ) ) {
	smntcs_retro_post_date();
}

// Display the post tags on post pages.
if ( get_theme_mod( 'smntcs_retro_page_show_tags', true ) ) {
	smntcs_retro_post_tags();
}

// Display the post categories on post pages.
if ( get_theme_mod( 'smntcs_retro_page_show_categories', true ) ) {
